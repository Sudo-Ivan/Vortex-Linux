...
This workspace is the **Sudo-Ivan/Vortex-Linux** fork of Nexus-Mods/Vortex. Prefer additive Linux packaging / CI changes that stay easy to merge from upstream. See README **What this fork changes** and **Upstream sync**.
...
Use `pnpm run` for repo commands. After code changes, run `build`, `test`, `lint`, and `format` on the affected package.
...
- Linux packaging / Flatpak / fork CI: README **What this fork changes** and **Upstream sync**
